...
const MarketingPage = () => {
  ...
  const [downTable,] = useState(false)
  ...
  const columns = [
    ...
    return (
      ...
      <li onClick={()=>setDelever('otviz')} className={`w-full py-2 pl-4 text-[14px] ${delever=='otziv'?'bg-[#4094F7] text-white':'bg-white text-[#252C32]'} leading-6 font-medium cursor-pointer  rounded-[6px]`}>Отзывы</li>
      </ul>
      </div>
